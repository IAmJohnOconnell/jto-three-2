      ...
      <div className="jobContainer">
        <div className="job hideBorder">
          ...
          <p className="jobDesc hidden">
            At MSI, I enhanced usability for online booking and e-gift
            applications, raising System Usability Scale (SUS) scores by over
            15% and significantly boosting user satisfaction. I redesigned and
            streamlined the mobile booking process, achieving a 46.3% increase
            in efficiency (Time To Completion).
          </p>
          <p className="jobDesc hidden">
            As the lead for the PRISM design system, I directed branding, UI
            consistency, and responsiveness across the platform, accelerating
            development and delivering a cohesive user experience.
          </p>
        </div>
        <div className="job hideBorder">
          ...
          <p className="jobDesc hidden">
            My favorite project was developing the sales application for VECTOR,
            the first North American-style fully electric fire truck: In an
            8-month timeframe the app was deployed, resulting in a 25% reduction
            in configuration errors and a 90% user adoption rate in the first
            three months. This realized a 34% increase in customer satisfaction
            (System Usability Scale).
          </p>
          <p className="jobDesc hidden">
            In addition to developing applications for other product lines, I
            refactored and modernized legacy systems to web-based technologies.
            This Increased NPS by over 28% and reduced load times by 42%.
          </p>
        </div>
        <div className="job hideBorder">
          ...
          <p className="jobDesc hidden">
            I supported the company’s email marketing campaigns by designing and
            coding custom templates, identifying new target demographics, and
            analyzing engagement metrics. These efforts increased open rates and
            customer retention, aligning with the company’s goal of growing
            brand recognition, and delivering consistent, value-driven
        ...
        <div className="job hideBorder">
          ...
          <p className="jobLoc hidden">Florida, USA</p>
          <p className="jobDesc hidden">
            I conducted user research and usability testing to gather insights
            and create clear, educational documentation for clients, enhancing
            their understanding of technical processes. By applying these
            findings to the development process, I streamlined user flows and
